...
const TmpWorkingDir = (0,once/* default */.A)(() => {
    const dir = (0,external_path_.join)((0,external_os_namespaceObject.tmpdir)(), 'devcontainer-creator-' + "421eceb0e2ccd62c92300cba8f1f2328a376d940");
...
const DevcontainerJSONTemplate = (desc) => {
    ...
    if (desc.extras?.includes('named-volumes') && desc.namedVolumes) {
        ...
        const command = `sudo chown -Rf ${remoteUser} ` +
