...
async function buildWithDevcontainerCli() {
    const { targetDir, tag: argTag, push, pushCache } = (0,parse_args/* ParsedArgs */.Ro)();
    if (push) {
...
const TmpWorkingDir = (0,once/* default */.A)(() => {
    const dir = (0,external_path_.join)((0,external_os_namespaceObject.tmpdir)(), 'devcontainer-creator-' + 1790354917118);
...
const ResolvedYaml = (0,once/* default */.A)(async () => {
    ...
    if (resolvedYaml.extras.includes('tmux')) {
        ...
        resolvedYaml.vscode.settings['terminal.integrated.automationProfile.linux'] = {
            path: '/usr/bin/bash',
        };
...
const DevcontainerJSONTemplate = (desc) => {
    ...
    if (desc.extras?.includes('named-volumes') && desc.namedVolumes) {
        ...
        const folders = Object.keys(desc.namedVolumes)
            .flatMap((k) => k.split('/').reduce((acc, _, i, arr) => {
            ...
            .join(' ');
        json.postCreateCommand = addCommand(json.postCreateCommand, `sudo install -d -o ${remoteUser} -g ${remoteUser} ${folders}`);
    }
...
module.exports = validate20;module.exports["default"] = validate20;const schema22 = {"$id":"https://example.com/language.schema.json","$schema":"http://json-schema.org/draft-07/schema","title":"Language","type":"object","additionalProperties":false,"$defs":{"devcontainer-build-file-type":{"type":"string","enum":["script","file"]},"devcontainer-build-file-content":{"type":"object","additionalProperties":false,"required":["type","path","content"],"properties":{"type":{"$ref":"#/$defs/devcontainer-build-file-type"},"path":{"type":"string"},"content":{"type":"string"}}},"devcontainer-build-file-base64":{"type":"object","additionalProperties":false,"required":["type","path","base64"],"properties":{"type":{"$ref":"#/$defs/devcontainer-build-file-type"},"path":{"type":"string"},"base64":{"type":"string"}}},"devcontainer-build-file":{"oneOf":[{"$ref":"#/$defs/devcontainer-build-file-content"},{"$ref":"#/$defs/devcontainer-build-file-base64"}]},"v-s-code-task":{"type":"object","additionalProperties":false,"required":["label","command"],"properties":{"label":{"type":"string"},"command":{"type":"string"}}}},"properties":{"extends":{"type":"string","enum":["base://debian","base://ubuntu","dcc://debian","dcc://lualatex","dcc://ubuntu"]},"devcontainer":{"type":"object","additionalProperties":false,"properties":{"name":{"type":"string"},"build":{"type":"object","additionalProperties":false,"properties":{"args":{"type":"object","additionalProperties":{"oneOf":[{"type":"string"},{"type":"number"}]}},"files":{"type":"array","items":{"$ref":"#/$defs/devcontainer-build-file"}},"prepare":{"type":"array","items":{"type":"string"}},"packages":{"type":"array","items":{"type":"string"}},"user":{"type":"array","items":{"type":"string"}},"root":{"type":"array","items":{"type":"string"}}}},"selftest":{"type":"string"},"remoteUser":{"type":"string"},"instantiate":{"type":"string"},"initialize":{"type":"string"},"ports":{"type":"array","items":{"type":"integer"}},"environment":{"type":"object","additionalProperties":{"type":"string"}},"publish":{"type":"object","additionalProperties":false,"required":["image"],"properties":{"image":{"type":"string"},"labels":{"type":"object","additionalProperties":{"type":"string"}}}}}},"vscode":{"type":"object","additionalProperties":false,"properties":{"extensions":{"type":"array","items":{"type":"string"}},"hideFiles":{"oneOf":[{"type":"array","items":{"type":"string"}},{"type":"boolean","not":{"const":true}}]},"settings":{"type":"object"},"tasks":{"type":"array","items":{"$ref":"#/$defs/v-s-code-task"}}}},"extras":{"type":"array","items":{"type":"string","enum":["forward-x11","traefik","tmpfs","named-volumes","tmux"]}},"traefik":{"type":"object","additionalProperties":false,"required":["network"],"properties":{"network":{"type":"string"},"labels":{"type":"object"}}},"tmpfs":{"type":"array","items":{"type":"string"}},"namedVolumes":{"type":"object","additionalProperties":{"type":"string"}}}};const schema28 = {"type":"object","additionalProperties":false,"required":["label","command"],"properties":{"label":{"type":"string"},"command":{"type":"string"}}};const func4 = Object.prototype.hasOwnProperty;const schema23 = {"oneOf":[{"$ref":"#/$defs/devcontainer-build-file-content"},{"$ref":"#/$defs/devcontainer-build-file-base64"}]};const schema24 = {"type":"object","additionalProperties":false,"required":["type","path","content"],"properties":{"type":{"$ref":"#/$defs/devcontainer-build-file-type"},"path":{"type":"string"},"content":{"type":"string"}}};const schema25 = {"type":"string","enum":["script","file"]};function validate22(data, {instancePath="", parentData, parentDataProperty, rootData=data}={}){let vErrors = null;let errors = 0;if(errors === 0){if(data && typeof data == "object" && !Array.isArray(data)){let missing0;if((((data.type === undefined) && (missing0 = "type")) || ((data.path === undefined) && (missing0 = "path"))) || ((data.content === undefined) && (missing0 = "content"))){validate22.errors = [{instancePath,schemaPath:"#/required",keyword:"required",params:{missingProperty: missing0},message:"must have required property '"+missing0+"'"}];return false;}else {const _errs1 = errors;for(const key0 in data){if(!(((key0 === "type") || (key0 === "path")) || (key0 === "content"))){validate22.errors = [{instancePath,schemaPath:"#/additionalProperties",keyword:"additionalProperties",params:{additionalProperty: key0},message:"must NOT have additional properties"}];return false;break;}}if(_errs1 === errors){if(data.type !== undefined){let data0 = data.type;const _errs2 = errors;if(typeof data0 !== "string"){validate22.errors = [{instancePath:instancePath+"/type",schemaPath:"#/$defs/devcontainer-build-file-type/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}if(!((data0 === "script") || (data0 === "file"))){validate22.errors = [{instancePath:instancePath+"/type",schemaPath:"#/$defs/devcontainer-build-file-type/enum",keyword:"enum",params:{allowedValues: schema25.enum},message:"must be equal to one of the allowed values"}];return false;}var valid0 = _errs2 === errors;}else {var valid0 = true;}if(valid0){if(data.path !== undefined){const _errs5 = errors;if(typeof data.path !== "string"){validate22.errors = [{instancePath:instancePath+"/path",schemaPath:"#/properties/path/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}var valid0 = _errs5 === errors;}else {var valid0 = true;}if(valid0){if(data.content !== undefined){const _errs7 = errors;if(typeof data.content !== "string"){validate22.errors = [{instancePath:instancePath+"/content",schemaPath:"#/properties/content/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}var valid0 = _errs7 === errors;}else {var valid0 = true;}}}}}}else {validate22.errors = [{instancePath,schemaPath:"#/type",keyword:"type",params:{type: "object"},message:"must be object"}];return false;}}validate22.errors = vErrors;return errors === 0;}const schema26 = {"type":"object","additionalProperties":false,"required":["type","path","base64"],"properties":{"type":{"$ref":"#/$defs/devcontainer-build-file-type"},"path":{"type":"string"},"base64":{"type":"string"}}};function validate24(data, {instancePath="", parentData, parentDataProperty, rootData=data}={}){let vErrors = null;let errors = 0;if(errors === 0){if(data && typeof data == "object" && !Array.isArray(data)){let missing0;if((((data.type === undefined) && (missing0 = "type")) || ((data.path === undefined) && (missing0 = "path"))) || ((data.base64 === undefined) && (missing0 = "base64"))){validate24.errors = [{instancePath,schemaPath:"#/required",keyword:"required",params:{missingProperty: missing0},message:"must have required property '"+missing0+"'"}];return false;}else {const _errs1 = errors;for(const key0 in data){if(!(((key0 === "type") || (key0 === "path")) || (key0 === "base64"))){validate24.errors = [{instancePath,schemaPath:"#/additionalProperties",keyword:"additionalProperties",params:{additionalProperty: key0},message:"must NOT have additional properties"}];return false;break;}}if(_errs1 === errors){if(data.type !== undefined){let data0 = data.type;const _errs2 = errors;if(typeof data0 !== "string"){validate24.errors = [{instancePath:instancePath+"/type",schemaPath:"#/$defs/devcontainer-build-file-type/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}if(!((data0 === "script") || (data0 === "file"))){validate24.errors = [{instancePath:instancePath+"/type",schemaPath:"#/$defs/devcontainer-build-file-type/enum",keyword:"enum",params:{allowedValues: schema25.enum},message:"must be equal to one of the allowed values"}];return false;}var valid0 = _errs2 === errors;}else {var valid0 = true;}if(valid0){if(data.path !== undefined){const _errs5 = errors;if(typeof data.path !== "string"){validate24.errors = [{instancePath:instancePath+"/path",schemaPath:"#/properties/path/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}var valid0 = _errs5 === errors;}else {var valid0 = true;}if(valid0){if(data.base64 !== undefined){const _errs7 = errors;if(typeof data.base64 !== "string"){validate24.errors = [{instancePath:instancePath+"/base64",schemaPath:"#/properties/base64/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}var valid0 = _errs7 === errors;}else {var valid0 = true;}}}}}}else {validate24.errors = [{instancePath,schemaPath:"#/type",keyword:"type",params:{type: "object"},message:"must be object"}];return false;}}validate24.errors = vErrors;return errors === 0;}function validate21(data, {instancePath="", parentData, parentDataProperty, rootData=data}={}){let vErrors = null;let errors = 0;const _errs0 = errors;let valid0 = false;let passing0 = null;const _errs1 = errors;if(!(validate22(data, {instancePath,parentData,parentDataProperty,rootData}))){vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);errors = vErrors.length;}var _valid0 = _errs1 === errors;if(_valid0){valid0 = true;passing0 = 0;}const _errs2 = errors;if(!(validate24(data, {instancePath,parentData,parentDataProperty,rootData}))){vErrors = vErrors === null ? validate24.errors : vErrors.concat(validate24.errors);errors = vErrors.length;}var _valid0 = _errs2 === errors;if(_valid0 && valid0){valid0 = false;passing0 = [passing0, 1];}else {if(_valid0){valid0 = true;passing0 = 1;}}if(!valid0){const err0 = {instancePath,schemaPath:"#/oneOf",keyword:"oneOf",params:{passingSchemas: passing0},message:"must match exactly one schema in oneOf"};if(vErrors === null){vErrors = [err0];}else {vErrors.push(err0);}errors++;validate21.errors = vErrors;return false;}else {errors = _errs0;if(vErrors !== null){if(_errs0){vErrors.length = _errs0;}else {vErrors = null;}}}validate21.errors = vErrors;return errors === 0;}function validate20(data, {instancePath="", parentData, parentDataProperty, rootData=data}={}){/*# sourceURL="https://example.com/language.schema.json" */;let vErrors = null;let errors = 0;if(errors === 0){if(data && typeof data == "object" && !Array.isArray(data)){const _errs1 = errors;for(const key0 in data){if(!(((((((key0 === "extends") || (key0 === "devcontainer")) || (key0 === "vscode")) || (key0 === "extras")) || (key0 === "traefik")) || (key0 === "tmpfs")) || (key0 === "namedVolumes"))){validate20.errors = [{instancePath,schemaPath:"#/additionalProperties",keyword:"additionalProperties",params:{additionalProperty: key0},message:"must NOT have additional properties"}];return false;break;}}if(_errs1 === errors){if(data.extends !== undefined){let data0 = data.extends;const _errs2 = errors;if(typeof data0 !== "string"){validate20.errors = [{instancePath:instancePath+"/extends",schemaPath:"#/properties/extends/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}if(!(((((data0 === "base://debian") || (data0 === "base://ubuntu")) || (data0 === "dcc://debian")) || (data0 === "dcc://lualatex")) || (data0 === "dcc://ubuntu"))){validate20.errors = [{instancePath:instancePath+"/extends",schemaPath:"#/properties/extends/enum",keyword:"enum",params:{allowedValues: schema22.properties.extends.enum},message:"must be equal to one of the allowed values"}];return false;}var valid0 = _errs2 === errors;}else {var valid0 = true;}if(valid0){if(data.devcontainer !== undefined){let data1 = data.devcontainer;const _errs4 = errors;if(errors === _errs4){if(data1 && typeof data1 == "object" && !Array.isArray(data1)){const _errs6 = errors;for(const key1 in data1){if(!(func4.call(schema22.properties.devcontainer.properties, key1))){validate20.errors = [{instancePath:instancePath+"/devcontainer",schemaPath:"#/properties/devcontainer/additionalProperties",keyword:"additionalProperties",params:{additionalProperty: key1},message:"must NOT have additional properties"}];return false;break;}}if(_errs6 === errors){if(data1.name !== undefined){const _errs7 = errors;if(typeof data1.name !== "string"){validate20.errors = [{instancePath:instancePath+"/devcontainer/name",schemaPath:"#/properties/devcontainer/properties/name/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}var valid1 = _errs7 === errors;}else {var valid1 = true;}if(valid1){if(data1.build !== undefined){let data3 = data1.build;const _errs9 = errors;if(errors === _errs9){if(data3 && typeof data3 == "object" && !Array.isArray(data3)){const _errs11 = errors;for(const key2 in data3){if(!((((((key2 === "args") || (key2 === "files")) || (key2 === "prepare")) || (key2 === "packages")) || (key2 === "user")) || (key2 === "root"))){validate20.errors = [{instancePath:instancePath+"/devcontainer/build",schemaPath:"#/properties/devcontainer/properties/build/additionalProperties",keyword:"additionalProperties",params:{additionalProperty: key2},message:"must NOT have additional properties"}];return false;break;}}if(_errs11 === errors){if(data3.args !== undefined){let data4 = data3.args;const _errs12 = errors;if(errors === _errs12){if(data4 && typeof data4 == "object" && !Array.isArray(data4)){for(const key3 in data4){let data5 = data4[key3];const _errs15 = errors;const _errs16 = errors;let valid4 = false;let passing0 = null;const _errs17 = errors;if(typeof data5 !== "string"){const err0 = {instancePath:instancePath+"/devcontainer/build/args/" + key3.replace(/~/g, "~0").replace(/\//g, "~1"),schemaPath:"#/properties/devcontainer/properties/build/properties/args/additionalProperties/oneOf/0/type",keyword:"type",params:{type: "string"},message:"must be string"};if(vErrors === null){vErrors = [err0];}else {vErrors.push(err0);}errors++;}var _valid0 = _errs17 === errors;if(_valid0){valid4 = true;passing0 = 0;}const _errs19 = errors;if(!((typeof data5 == "number") && (isFinite(data5)))){const err1 = {instancePath:instancePath+"/devcontainer/build/args/" + key3.replace(/~/g, "~0").replace(/\//g, "~1"),schemaPath:"#/properties/devcontainer/properties/build/properties/args/additionalProperties/oneOf/1/type",keyword:"type",params:{type: "number"},message:"must be number"};if(vErrors === null){vErrors = [err1];}else {vErrors.push(err1);}errors++;}var _valid0 = _errs19 === errors;if(_valid0 && valid4){valid4 = false;passing0 = [passing0, 1];}else {if(_valid0){valid4 = true;passing0 = 1;}}if(!valid4){const err2 = {instancePath:instancePath+"/devcontainer/build/args/" + key3.replace(/~/g, "~0").replace(/\//g, "~1"),schemaPath:"#/properties/devcontainer/properties/build/properties/args/additionalProperties/oneOf",keyword:"oneOf",params:{passingSchemas: passing0},message:"must match exactly one schema in oneOf"};if(vErrors === null){vErrors = [err2];}else {vErrors.push(err2);}errors++;validate20.errors = vErrors;return false;}else {errors = _errs16;if(vErrors !== null){if(_errs16){vErrors.length = _errs16;}else {vErrors = null;}}}var valid3 = _errs15 === errors;if(!valid3){break;}}}else {validate20.errors = [{instancePath:instancePath+"/devcontainer/build/args",schemaPath:"#/properties/devcontainer/properties/build/properties/args/type",keyword:"type",params:{type: "object"},message:"must be object"}];return false;}}var valid2 = _errs12 === errors;}else {var valid2 = true;}if(valid2){if(data3.files !== undefined){let data6 = data3.files;const _errs21 = errors;if(errors === _errs21){if(Array.isArray(data6)){var valid5 = true;const len0 = data6.length;for(let i0=0; i0<len0; i0++){const _errs23 = errors;if(!(validate21(data6[i0], {instancePath:instancePath+"/devcontainer/build/files/" + i0,parentData:data6,parentDataProperty:i0,rootData}))){vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);errors = vErrors.length;}var valid5 = _errs23 === errors;if(!valid5){break;}}}else {validate20.errors = [{instancePath:instancePath+"/devcontainer/build/files",schemaPath:"#/properties/devcontainer/properties/build/properties/files/type",keyword:"type",params:{type: "array"},message:"must be array"}];return false;}}var valid2 = _errs21 === errors;}else {var valid2 = true;}if(valid2){if(data3.prepare !== undefined){let data8 = data3.prepare;const _errs24 = errors;if(errors === _errs24){if(Array.isArray(data8)){var valid6 = true;const len1 = data8.length;for(let i1=0; i1<len1; i1++){const _errs26 = errors;if(typeof data8[i1] !== "string"){validate20.errors = [{instancePath:instancePath+"/devcontainer/build/prepare/" + i1,schemaPath:"#/properties/devcontainer/properties/build/properties/prepare/items/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}var valid6 = _errs26 === errors;if(!valid6){break;}}}else {validate20.errors = [{instancePath:instancePath+"/devcontainer/build/prepare",schemaPath:"#/properties/devcontainer/properties/build/properties/prepare/type",keyword:"type",params:{type: "array"},message:"must be array"}];return false;}}var valid2 = _errs24 === errors;}else {var valid2 = true;}if(valid2){if(data3.packages !== undefined){let data10 = data3.packages;const _errs28 = errors;if(errors === _errs28){if(Array.isArray(data10)){var valid7 = true;const len2 = data10.length;for(let i2=0; i2<len2; i2++){const _errs30 = errors;if(typeof data10[i2] !== "string"){validate20.errors = [{instancePath:instancePath+"/devcontainer/build/packages/" + i2,schemaPath:"#/properties/devcontainer/properties/build/properties/packages/items/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}var valid7 = _errs30 === errors;if(!valid7){break;}}}else {validate20.errors = [{instancePath:instancePath+"/devcontainer/build/packages",schemaPath:"#/properties/devcontainer/properties/build/properties/packages/type",keyword:"type",params:{type: "array"},message:"must be array"}];return false;}}var valid2 = _errs28 === errors;}else {var valid2 = true;}if(valid2){if(data3.user !== undefined){let data12 = data3.user;const _errs32 = errors;if(errors === _errs32){if(Array.isArray(data12)){var valid8 = true;const len3 = data12.length;for(let i3=0; i3<len3; i3++){const _errs34 = errors;if(typeof data12[i3] !== "string"){validate20.errors = [{instancePath:instancePath+"/devcontainer/build/user/" + i3,schemaPath:"#/properties/devcontainer/properties/build/properties/user/items/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}var valid8 = _errs34 === errors;if(!valid8){break;}}}else {validate20.errors = [{instancePath:instancePath+"/devcontainer/build/user",schemaPath:"#/properties/devcontainer/properties/build/properties/user/type",keyword:"type",params:{type: "array"},message:"must be array"}];return false;}}var valid2 = _errs32 === errors;}else {var valid2 = true;}if(valid2){if(data3.root !== undefined){let data14 = data3.root;const _errs36 = errors;if(errors === _errs36){if(Array.isArray(data14)){var valid9 = true;const len4 = data14.length;for(let i4=0; i4<len4; i4++){const _errs38 = errors;if(typeof data14[i4] !== "string"){validate20.errors = [{instancePath:instancePath+"/devcontainer/build/root/" + i4,schemaPath:"#/properties/devcontainer/properties/build/properties/root/items/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}var valid9 = _errs38 === errors;if(!valid9){break;}}}else {validate20.errors = [{instancePath:instancePath+"/devcontainer/build/root",schemaPath:"#/properties/devcontainer/properties/build/properties/root/type",keyword:"type",params:{type: "array"},message:"must be array"}];return false;}}var valid2 = _errs36 === errors;}else {var valid2 = true;}}}}}}}}else {validate20.errors = [{instancePath:instancePath+"/devcontainer/build",schemaPath:"#/properties/devcontainer/properties/build/type",keyword:"type",params:{type: "object"},message:"must be object"}];return false;}}var valid1 = _errs9 === errors;}else {var valid1 = true;}if(valid1){if(data1.selftest !== undefined){const _errs40 = errors;if(typeof data1.selftest !== "string"){validate20.errors = [{instancePath:instancePath+"/devcontainer/selftest",schemaPath:"#/properties/devcontainer/properties/selftest/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}var valid1 = _errs40 === errors;}else {var valid1 = true;}if(valid1){if(data1.remoteUser !== undefined){const _errs42 = errors;if(typeof data1.remoteUser !== "string"){validate20.errors = [{instancePath:instancePath+"/devcontainer/remoteUser",schemaPath:"#/properties/devcontainer/properties/remoteUser/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}var valid1 = _errs42 === errors;}else {var valid1 = true;}if(valid1){if(data1.instantiate !== undefined){const _errs44 = errors;if(typeof data1.instantiate !== "string"){validate20.errors = [{instancePath:instancePath+"/devcontainer/instantiate",schemaPath:"#/properties/devcontainer/properties/instantiate/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}var valid1 = _errs44 === errors;}else {var valid1 = true;}if(valid1){if(data1.initialize !== undefined){const _errs46 = errors;if(typeof data1.initialize !== "string"){validate20.errors = [{instancePath:instancePath+"/devcontainer/initialize",schemaPath:"#/properties/devcontainer/properties/initialize/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}var valid1 = _errs46 === errors;}else {var valid1 = true;}if(valid1){if(data1.ports !== undefined){let data20 = data1.ports;const _errs48 = errors;if(errors === _errs48){if(Array.isArray(data20)){var valid10 = true;const len5 = data20.length;for(let i5=0; i5<len5; i5++){let data21 = data20[i5];const _errs50 = errors;if(!(((typeof data21 == "number") && (!(data21 % 1) && !isNaN(data21))) && (isFinite(data21)))){validate20.errors = [{instancePath:instancePath+"/devcontainer/ports/" + i5,schemaPath:"#/properties/devcontainer/properties/ports/items/type",keyword:"type",params:{type: "integer"},message:"must be integer"}];return false;}var valid10 = _errs50 === errors;if(!valid10){break;}}}else {validate20.errors = [{instancePath:instancePath+"/devcontainer/ports",schemaPath:"#/properties/devcontainer/properties/ports/type",keyword:"type",params:{type: "array"},message:"must be array"}];return false;}}var valid1 = _errs48 === errors;}else {var valid1 = true;}if(valid1){if(data1.environment !== undefined){let data22 = data1.environment;const _errs52 = errors;if(errors === _errs52){if(data22 && typeof data22 == "object" && !Array.isArray(data22)){for(const key4 in data22){const _errs55 = errors;if(typeof data22[key4] !== "string"){validate20.errors = [{instancePath:instancePath+"/devcontainer/environment/" + key4.replace(/~/g, "~0").replace(/\//g, "~1"),schemaPath:"#/properties/devcontainer/properties/environment/additionalProperties/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}var valid11 = _errs55 === errors;if(!valid11){break;}}}else {validate20.errors = [{instancePath:instancePath+"/devcontainer/environment",schemaPath:"#/properties/devcontainer/properties/environment/type",keyword:"type",params:{type: "object"},message:"must be object"}];return false;}}var valid1 = _errs52 === errors;}else {var valid1 = true;}if(valid1){if(data1.publish !== undefined){let data24 = data1.publish;const _errs57 = errors;if(errors === _errs57){if(data24 && typeof data24 == "object" && !Array.isArray(data24)){let missing0;if((data24.image === undefined) && (missing0 = "image")){validate20.errors = [{instancePath:instancePath+"/devcontainer/publish",schemaPath:"#/properties/devcontainer/properties/publish/required",keyword:"required",params:{missingProperty: missing0},message:"must have required property '"+missing0+"'"}];return false;}else {const _errs59 = errors;for(const key5 in data24){if(!((key5 === "image") || (key5 === "labels"))){validate20.errors = [{instancePath:instancePath+"/devcontainer/publish",schemaPath:"#/properties/devcontainer/properties/publish/additionalProperties",keyword:"additionalProperties",params:{additionalProperty: key5},message:"must NOT have additional properties"}];return false;break;}}if(_errs59 === errors){if(data24.image !== undefined){const _errs60 = errors;if(typeof data24.image !== "string"){validate20.errors = [{instancePath:instancePath+"/devcontainer/publish/image",schemaPath:"#/properties/devcontainer/properties/publish/properties/image/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}var valid12 = _errs60 === errors;}else {var valid12 = true;}if(valid12){if(data24.labels !== undefined){let data26 = data24.labels;const _errs62 = errors;if(errors === _errs62){if(data26 && typeof data26 == "object" && !Array.isArray(data26)){for(const key6 in data26){const _errs65 = errors;if(typeof data26[key6] !== "string"){validate20.errors = [{instancePath:instancePath+"/devcontainer/publish/labels/" + key6.replace(/~/g, "~0").replace(/\//g, "~1"),schemaPath:"#/properties/devcontainer/properties/publish/properties/labels/additionalProperties/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}var valid13 = _errs65 === errors;if(!valid13){break;}}}else {validate20.errors = [{instancePath:instancePath+"/devcontainer/publish/labels",schemaPath:"#/properties/devcontainer/properties/publish/properties/labels/type",keyword:"type",params:{type: "object"},message:"must be object"}];return false;}}var valid12 = _errs62 === errors;}else {var valid12 = true;}}}}}else {validate20.errors = [{instancePath:instancePath+"/devcontainer/publish",schemaPath:"#/properties/devcontainer/properties/publish/type",keyword:"type",params:{type: "object"},message:"must be object"}];return false;}}var valid1 = _errs57 === errors;}else {var valid1 = true;}}}}}}}}}}}else {validate20.errors = [{instancePath:instancePath+"/devcontainer",schemaPath:"#/properties/devcontainer/type",keyword:"type",params:{type: "object"},message:"must be object"}];return false;}}var valid0 = _errs4 === errors;}else {var valid0 = true;}if(valid0){if(data.vscode !== undefined){let data28 = data.vscode;const _errs67 = errors;if(errors === _errs67){if(data28 && typeof data28 == "object" && !Array.isArray(data28)){const _errs69 = errors;for(const key7 in data28){if(!((((key7 === "extensions") || (key7 === "hideFiles")) || (key7 === "settings")) || (key7 === "tasks"))){validate20.errors = [{instancePath:instancePath+"/vscode",schemaPath:"#/properties/vscode/additionalProperties",keyword:"additionalProperties",params:{additionalProperty: key7},message:"must NOT have additional properties"}];return false;break;}}if(_errs69 === errors){if(data28.extensions !== undefined){let data29 = data28.extensions;const _errs70 = errors;if(errors === _errs70){if(Array.isArray(data29)){var valid15 = true;const len6 = data29.length;for(let i6=0; i6<len6; i6++){const _errs72 = errors;if(typeof data29[i6] !== "string"){validate20.errors = [{instancePath:instancePath+"/vscode/extensions/" + i6,schemaPath:"#/properties/vscode/properties/extensions/items/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}var valid15 = _errs72 === errors;if(!valid15){break;}}}else {validate20.errors = [{instancePath:instancePath+"/vscode/extensions",schemaPath:"#/properties/vscode/properties/extensions/type",keyword:"type",params:{type: "array"},message:"must be array"}];return false;}}var valid14 = _errs70 === errors;}else {var valid14 = true;}if(valid14){if(data28.hideFiles !== undefined){let data31 = data28.hideFiles;const _errs74 = errors;const _errs75 = errors;let valid16 = false;let passing1 = null;const _errs76 = errors;if(errors === _errs76){if(Array.isArray(data31)){var valid17 = true;const len7 = data31.length;for(let i7=0; i7<len7; i7++){const _errs78 = errors;if(typeof data31[i7] !== "string"){const err3 = {instancePath:instancePath+"/vscode/hideFiles/" + i7,schemaPath:"#/properties/vscode/properties/hideFiles/oneOf/0/items/type",keyword:"type",params:{type: "string"},message:"must be string"};if(vErrors === null){vErrors = [err3];}else {vErrors.push(err3);}errors++;}var valid17 = _errs78 === errors;if(!valid17){break;}}}else {const err4 = {instancePath:instancePath+"/vscode/hideFiles",schemaPath:"#/properties/vscode/properties/hideFiles/oneOf/0/type",keyword:"type",params:{type: "array"},message:"must be array"};if(vErrors === null){vErrors = [err4];}else {vErrors.push(err4);}errors++;}}var _valid1 = _errs76 === errors;if(_valid1){valid16 = true;passing1 = 0;}const _errs80 = errors;if(typeof data31 !== "boolean"){const err5 = {instancePath:instancePath+"/vscode/hideFiles",schemaPath:"#/properties/vscode/properties/hideFiles/oneOf/1/type",keyword:"type",params:{type: "boolean"},message:"must be boolean"};if(vErrors === null){vErrors = [err5];}else {vErrors.push(err5);}errors++;}const _errs82 = errors;const _errs83 = errors;if(true !== data31){const err6 = {};if(vErrors === null){vErrors = [err6];}else {vErrors.push(err6);}errors++;}var valid18 = _errs83 === errors;if(valid18){const err7 = {instancePath:instancePath+"/vscode/hideFiles",schemaPath:"#/properties/vscode/properties/hideFiles/oneOf/1/not",keyword:"not",params:{},message:"must NOT be valid"};if(vErrors === null){vErrors = [err7];}else {vErrors.push(err7);}errors++;}else {errors = _errs82;if(vErrors !== null){if(_errs82){vErrors.length = _errs82;}else {vErrors = null;}}}var _valid1 = _errs80 === errors;if(_valid1 && valid16){valid16 = false;passing1 = [passing1, 1];}else {if(_valid1){valid16 = true;passing1 = 1;}}if(!valid16){const err8 = {instancePath:instancePath+"/vscode/hideFiles",schemaPath:"#/properties/vscode/properties/hideFiles/oneOf",keyword:"oneOf",params:{passingSchemas: passing1},message:"must match exactly one schema in oneOf"};if(vErrors === null){vErrors = [err8];}else {vErrors.push(err8);}errors++;validate20.errors = vErrors;return false;}else {errors = _errs75;if(vErrors !== null){if(_errs75){vErrors.length = _errs75;}else {vErrors = null;}}}var valid14 = _errs74 === errors;}else {var valid14 = true;}if(valid14){if(data28.settings !== undefined){let data33 = data28.settings;const _errs84 = errors;if(!(data33 && typeof data33 == "object" && !Array.isArray(data33))){validate20.errors = [{instancePath:instancePath+"/vscode/settings",schemaPath:"#/properties/vscode/properties/settings/type",keyword:"type",params:{type: "object"},message:"must be object"}];return false;}var valid14 = _errs84 === errors;}else {var valid14 = true;}if(valid14){if(data28.tasks !== undefined){let data34 = data28.tasks;const _errs86 = errors;if(errors === _errs86){if(Array.isArray(data34)){var valid19 = true;const len8 = data34.length;for(let i8=0; i8<len8; i8++){let data35 = data34[i8];const _errs88 = errors;const _errs89 = errors;if(errors === _errs89){if(data35 && typeof data35 == "object" && !Array.isArray(data35)){let missing1;if(((data35.label === undefined) && (missing1 = "label")) || ((data35.command === undefined) && (missing1 = "command"))){validate20.errors = [{instancePath:instancePath+"/vscode/tasks/" + i8,schemaPath:"#/$defs/v-s-code-task/required",keyword:"required",params:{missingProperty: missing1},message:"must have required property '"+missing1+"'"}];return false;}else {const _errs91 = errors;for(const key8 in data35){if(!((key8 === "label") || (key8 === "command"))){validate20.errors = [{instancePath:instancePath+"/vscode/tasks/" + i8,schemaPath:"#/$defs/v-s-code-task/additionalProperties",keyword:"additionalProperties",params:{additionalProperty: key8},message:"must NOT have additional properties"}];return false;break;}}if(_errs91 === errors){if(data35.label !== undefined){const _errs92 = errors;if(typeof data35.label !== "string"){validate20.errors = [{instancePath:instancePath+"/vscode/tasks/" + i8+"/label",schemaPath:"#/$defs/v-s-code-task/properties/label/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}var valid21 = _errs92 === errors;}else {var valid21 = true;}if(valid21){if(data35.command !== undefined){const _errs94 = errors;if(typeof data35.command !== "string"){validate20.errors = [{instancePath:instancePath+"/vscode/tasks/" + i8+"/command",schemaPath:"#/$defs/v-s-code-task/properties/command/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}var valid21 = _errs94 === errors;}else {var valid21 = true;}}}}}else {validate20.errors = [{instancePath:instancePath+"/vscode/tasks/" + i8,schemaPath:"#/$defs/v-s-code-task/type",keyword:"type",params:{type: "object"},message:"must be object"}];return false;}}var valid19 = _errs88 === errors;if(!valid19){break;}}}else {validate20.errors = [{instancePath:instancePath+"/vscode/tasks",schemaPath:"#/properties/vscode/properties/tasks/type",keyword:"type",params:{type: "array"},message:"must be array"}];return false;}}var valid14 = _errs86 === errors;}else {var valid14 = true;}}}}}}else {validate20.errors = [{instancePath:instancePath+"/vscode",schemaPath:"#/properties/vscode/type",keyword:"type",params:{type: "object"},message:"must be object"}];return false;}}var valid0 = _errs67 === errors;}else {var valid0 = true;}if(valid0){if(data.extras !== undefined){let data38 = data.extras;const _errs96 = errors;if(errors === _errs96){if(Array.isArray(data38)){var valid22 = true;const len9 = data38.length;for(let i9=0; i9<len9; i9++){let data39 = data38[i9];const _errs98 = errors;if(typeof data39 !== "string"){validate20.errors = [{instancePath:instancePath+"/extras/" + i9,schemaPath:"#/properties/extras/items/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}if(!(((((data39 === "forward-x11") || (data39 === "traefik")) || (data39 === "tmpfs")) || (data39 === "named-volumes")) || (data39 === "tmux"))){validate20.errors = [{instancePath:instancePath+"/extras/" + i9,schemaPath:"#/properties/extras/items/enum",keyword:"enum",params:{allowedValues: schema22.properties.extras.items.enum},message:"must be equal to one of the allowed values"}];return false;}var valid22 = _errs98 === errors;if(!valid22){break;}}}else {validate20.errors = [{instancePath:instancePath+"/extras",schemaPath:"#/properties/extras/type",keyword:"type",params:{type: "array"},message:"must be array"}];return false;}}var valid0 = _errs96 === errors;}else {var valid0 = true;}if(valid0){if(data.traefik !== undefined){let data40 = data.traefik;const _errs100 = errors;if(errors === _errs100){if(data40 && typeof data40 == "object" && !Array.isArray(data40)){let missing2;if((data40.network === undefined) && (missing2 = "network")){validate20.errors = [{instancePath:instancePath+"/traefik",schemaPath:"#/properties/traefik/required",keyword:"required",params:{missingProperty: missing2},message:"must have required property '"+missing2+"'"}];return false;}else {const _errs102 = errors;for(const key9 in data40){if(!((key9 === "network") || (key9 === "labels"))){validate20.errors = [{instancePath:instancePath+"/traefik",schemaPath:"#/properties/traefik/additionalProperties",keyword:"additionalProperties",params:{additionalProperty: key9},message:"must NOT have additional properties"}];return false;break;}}if(_errs102 === errors){if(data40.network !== undefined){const _errs103 = errors;if(typeof data40.network !== "string"){validate20.errors = [{instancePath:instancePath+"/traefik/network",schemaPath:"#/properties/traefik/properties/network/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}var valid23 = _errs103 === errors;}else {var valid23 = true;}if(valid23){if(data40.labels !== undefined){let data42 = data40.labels;const _errs105 = errors;if(!(data42 && typeof data42 == "object" && !Array.isArray(data42))){validate20.errors = [{instancePath:instancePath+"/traefik/labels",schemaPath:"#/properties/traefik/properties/labels/type",keyword:"type",params:{type: "object"},message:"must be object"}];return false;}var valid23 = _errs105 === errors;}else {var valid23 = true;}}}}}else {validate20.errors = [{instancePath:instancePath+"/traefik",schemaPath:"#/properties/traefik/type",keyword:"type",params:{type: "object"},message:"must be object"}];return false;}}var valid0 = _errs100 === errors;}else {var valid0 = true;}if(valid0){if(data.tmpfs !== undefined){let data43 = data.tmpfs;const _errs107 = errors;if(errors === _errs107){if(Array.isArray(data43)){var valid24 = true;const len10 = data43.length;for(let i10=0; i10<len10; i10++){const _errs109 = errors;if(typeof data43[i10] !== "string"){validate20.errors = [{instancePath:instancePath+"/tmpfs/" + i10,schemaPath:"#/properties/tmpfs/items/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}var valid24 = _errs109 === errors;if(!valid24){break;}}}else {validate20.errors = [{instancePath:instancePath+"/tmpfs",schemaPath:"#/properties/tmpfs/type",keyword:"type",params:{type: "array"},message:"must be array"}];return false;}}var valid0 = _errs107 === errors;}else {var valid0 = true;}if(valid0){if(data.namedVolumes !== undefined){let data45 = data.namedVolumes;const _errs111 = errors;if(errors === _errs111){if(data45 && typeof data45 == "object" && !Array.isArray(data45)){for(const key10 in data45){const _errs114 = errors;if(typeof data45[key10] !== "string"){validate20.errors = [{instancePath:instancePath+"/namedVolumes/" + key10.replace(/~/g, "~0").replace(/\//g, "~1"),schemaPath:"#/properties/namedVolumes/additionalProperties/type",keyword:"type",params:{type: "string"},message:"must be string"}];return false;}var valid25 = _errs114 === errors;if(!valid25){break;}}}else {validate20.errors = [{instancePath:instancePath+"/namedVolumes",schemaPath:"#/properties/namedVolumes/type",keyword:"type",params:{type: "object"},message:"must be object"}];return false;}}var valid0 = _errs111 === errors;}else {var valid0 = true;}}}}}}}}}else {validate20.errors = [{instancePath,schemaPath:"#/type",keyword:"type",params:{type: "object"},message:"must be object"}];return false;}}validate20.errors = vErrors;return errors === 0;}
